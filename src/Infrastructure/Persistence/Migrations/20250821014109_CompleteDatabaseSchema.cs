    ...
    public partial class CompleteDatabaseSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 8, 21, 1, 41, 9, 399, DateTimeKind.Utc).AddTicks(2400), "Administrator with full access to manage users and system settings", "Admin" },
                    { 2, new DateTime(2025, 8, 21, 1, 41, 9, 399, DateTimeKind.Utc).AddTicks(2400), "Regular user who can manage their own profile and hobbies", "User" }
                });
